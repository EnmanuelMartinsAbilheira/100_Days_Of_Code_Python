...
days_year = age_as_int * 365
weeks_year = age_as_int * 52
months_year = age_as_int * 12

message = f"you have {days_year} days, {weeks_year} weeks, and. {months_year} months left"
print(message)
